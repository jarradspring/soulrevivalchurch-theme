            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                ...
                <div class="recent recent_sermons visible-lg">
                    <div class="links">
                        ...
                        <span class="small_text title"><?php the_sub_field('featured_sermon_title'); ?></span>
                        <span class="small_text preacher hidden-md"><?php the_sub_field('featured_preacher'); ?></span>
                        <audio src="<?php the_sub_field('audio'); ?>" preload="auto"></audio>
                    </div>
                    <div class="image">
                        <img src="<?php the_sub_field('featured_series_image'); ?>" alt="<?php the_sub_field('featured_series_title'); ?>" />
                    </div>
                </div>
